...
class ChartController extends Controller
{
    ...
    {
        $barang = BarangModel::where(DB::raw("(DATE_FORMAT(created_at,'%Y'))"),date('Y'))->get();    
        $transaksi = TransaksiModel::where(DB::raw("(DATE_FORMAT(created_at,'%Y'))"),date('Y'))->get();
        $chart = Charts::database($barang, 'bar', 'highcharts')
		...
		$line_chart = Charts::database($transaksi,'line', 'highcharts')

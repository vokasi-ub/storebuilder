...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{ assets ('assets/admin/css/bootstrap.min.css') }}" />
		<link rel="stylesheet" href="{{ assets ('assets/admin/font-awesome/4.5.0/css/font-awesome.min.css') }}" />

		<!-- page specific plugin styles -->

		<!-- text fonts -->
		<link rel="stylesheet" href="{{ assets ('assets/admin/css/fonts.googleapis.com.css') }}" />

		<!-- ace styles -->
		<link rel="stylesheet" href="{{ assets ('assets/admin/css/ace.min.css') }}" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
		<link rel="stylesheet" href="{{ assets ('assets/admin/css/ace-skins.min.css') }}" />
		<link rel="stylesheet" href="{{ assets ('assets/admin/css/ace-rtl.min.css') }}" />
		...
		<script src="{{ assets ('assets/admin/js/ace-extra.min.js') }}"></script>
...
<![endif]-->
		...
		<![endif]-->
		<script src="{{ assets ('assets/admin/js/jquery-ui.custom.min.js') }}"></script>
		<script src="{{ assets ('assets/admin/js/jquery.ui.touch-punch.min.js') }}"></script>
		<script src="{{ assets ('assets/admin/js/jquery.easypiechart.min.js') }}"></script>
		<script src="{{ assets ('assets/admin/js/jquery.sparkline.index.min.js') }}"></script>
		<script src="{{ assets ('assets/admin/js/jquery.flot.min.js') }}"></script>
		<script src="{{ assets ('assets/admin//js/jquery.flot.pie.min.js') }}"></script>
		<script src="{{ assets ('assets/admin/js/jquery.flot.resize.min.js') }}"></script>

		<!-- ace scripts -->
		<script src="{{ assets ('assets/admin//js/ace-elements.min.js'}}"></script>
		<script src="{{ assets ('assets/admin//js/ace.min.js') }}"></script>

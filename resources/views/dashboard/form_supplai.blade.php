        ...
        <div class="modal-content">
            <form id="form-barang" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <input type="hidden" id="id_supplai" name="id_supplai">
                    
                    <div class="form-group">
                        <label for="kode_supplai" class="col-md-3 control-label">Kode Supplai</label>
                        <div class="col-md-6">
                            <input type="text" id="kode_supplai" name="kode_supplai" class="form-control" autofocus required>
